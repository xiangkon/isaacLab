...
class PiperCubeLiftEnvCfg(joint_pos_env_cfg.PiperCubeLiftEnvCfg):
    def __post_init__(self):
        ...
        self.actions.arm_action = DifferentialInverseKinematicsActionCfg(
            asset_name="robot",
            joint_names=["piper_joint.*"],
            body_name="piper_link6",
...
class PiperTeddyBearLiftEnvCfg(PiperCubeLiftEnvCfg):
    def __post_init__(self):
        ...
        self.scene.robot.actuators["hand"].effort_limit = 50.0
        self.scene.robot.actuators["hand"].stiffness = 40.0
        self.scene.robot.actuators["hand"].damping = 10.0
